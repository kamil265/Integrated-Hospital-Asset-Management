<?php
    ...
    {   
        ...
        if(isset($_POST['insertPerawat']))
        {
            ...
            $sql="INSERT INTO  tb_perawat(rfid_uid,nama_perawat,nik_perawat,jenis_kelamin,alamat,kontak_perawat) VALUES (:perawatUID,:perawatNama,:perawatNIK,:perawatJenisKelamin,:perawatAlamat,:perawatKontak)";
