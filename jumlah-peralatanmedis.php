    ...
    <div class="col-12">
		    <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Status Perlatan Medis</h4>
            	</div>
                <div class="card-body">
                        ...
                        <table id="example5" class="display" style="min-width: 100px">
                            ...
                            <tbody>
                            	...
                            	<tr>
                                    ...
                                    <td>
                                    <div class="d-flex">
											<a href="proses-editjumlahinventory.php?id=<?php echo htmlentities($result->id);?>" class="btn btn-primary shadow btn-xs sharp mr-1 openmodaleditcat" ><i class="fa fa-pencil" ></i></a>
                                            <a href="hapus-jumlahinventory.php?id=<?php echo htmlentities($result->id);?>"  class="btn btn-danger shadow btn-xs sharp" ><i class="fa fa-trash"></i></a>
										</div>							
                                    </td>				
                                </tr>
                                <?php $cnt=$cnt+1; }}?>
