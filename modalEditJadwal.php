<?php 
    include'connect.php';
    $idsc=$_GET['id'];
	$sql = "SELECT*from tb_jadwaldokter WHERE id=$idsc";
...
?>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="editJadwal.php?id=<?php echo htmlentities ($result->id);?>" method="POST"  class="step-form-horizontal">
                <div>                    
                    <section>
                        <div class="row">
                        	<div class="col-lg-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="uid_jadwaldok" id="uid_jadwaldok" disabled value="<?php echo htmlentities($result->dokter_id);?>" class="form-control" required>
                                </div>
								<div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="updateJadwalDokter" class="btn btn-primary">Tambah</button>
                </div>
            </form>
        </div>
        </div>
