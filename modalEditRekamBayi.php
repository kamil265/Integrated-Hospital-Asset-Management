<?php 
    include'connect.php';
    $idpas=$_GET['id'];
	$sql = "SELECT*from rekammedis WHERE kategori_pasien='Bayi' AND id=$idpas";
...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-body">
        <form action="editRekamBayi.php?id=<?php echo htmlentities ($result->id);?>" method="POST"  class="step-form-horizontal">
            <div>                    
                <section>
                    <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="updateBayi" class="btn btn-primary">Edit</button>
                </div>
            </form>
        </div>            
     </div>
