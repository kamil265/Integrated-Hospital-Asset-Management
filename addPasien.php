<?php
    ...
    // else{ 
        if(isset($_POST['insertPasien']))
        {
            ...
            $sql="INSERT INTO tb_pasien(kode_rfid,nik,nama,jeniskelamin_pasien,tanggal_lahir,alamat,Penanggungjawab,diagnosa,dokter_penanggungjawab,kategori_pasien,status_pasien) VALUES (:uidPas,:nik,:nama,:jenisKelamin,:tanggalLahir,:alamat,:pj,:diagnosa,:dokterPenanggungjawab,:kategori,:statusPasien)";
