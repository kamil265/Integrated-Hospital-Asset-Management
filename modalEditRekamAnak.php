<?php 
    include'connect.php';
    $idpas=$_GET['id'];
	$sql = "SELECT*from rekammedis WHERE kategori_pasien='Anak' AND id=$idpas";
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">Edit REKAM MEDIS - ANAK</h3>
            <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
            </button>
        </div>
    <div class="modal-body">
        <form action="editRekamAnak.php?id=<?php echo htmlentities ($result->id);?>" method="POST"  class="step-form-horizontal">
            <div>                    
                <section>
                    <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="updateAnak" class="btn btn-primary">Edit</button>
                </div>
            </form>
        </div>            
     </div>
